...
class order extends MY_Controller
{
    ...
    public function myOrder()
    {
        ...
        do {
            ...
            $this->load->model('model_order', 'order');
            $field = 'order_sn,city_id,chauffeur_id,uid,uname,user_phone,chauffeur_login_name,chauffeur_phone,amount,status,
                train_address,getoff_address,train_time,getoff_time,create_time,is_invoice,payable,content,mailing_address,leave_message';
