...
require_once(APPPATH.'libraries/nusoaplib/nusoap.php');
...
class client{
	 ...
	 * 
	 */
	function clients($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
	{
		$this->url = $url;
