            ...
            <form class="form-horizontal" action="<?=url('admin')?>message/save" method="post" onsubmit="return checkForm()">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea rows="3" id="content" class="input-xlarge" name="content" onkeypress="return limitChars('content', 100, 'content_notice')"><?=isset ($data['content']) ? $data['content'] : ''?></textarea>
