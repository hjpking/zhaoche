...
<div class="container-fluid" >
    <div class="row-fluid">
        ...
        <div class="span10">
            ...
            <form class=" well form-inline" action="<?=url('admin')?>/city/useful_index" method="post">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <td><?=$v['create_time'];?></td>
                    <td>
                        <a href="<?=url('admin')?>city/useful_edit/<?=$v['ua_id'];?>" title="编辑"><i class="icon-edit"></i></a>
                        <a href="<?=url('admin')?>city/useful_delete/<?=$v['ua_id'];?>" title="删除"><i class="icon-remove"></i></a>
                    </td>
                </tr>
                <?php }?>
                </tbody>
